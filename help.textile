...
h1. Speed up your TXP websites now!
...
* v0.1 on 22 Jul 2009. First release
* v0.2 on 26 Jul 2009. Second release. Adding some code submitted by Rudd.
* v0.3 on 28 Jul 2009. Third release. Mask html comments and css comments but preserve IE conditional comments.
* v0.3.a on Jul 2009. Intermediate pre final release. The array() had been changed by a stronger regex.
* v0.3.b on 30 Jul 2009. Final release. Support for @pre@ tags.
* v0.4 on 29 Jul 2009. _Non intrusive release_:  Add "enable" attribute.
* v0.4a & v0.4b. Unpublished. For testing purposes only.
* v0.4c on 06 Jul 2011. Add support in regex for "HTML5/Boilerplate" doctype declaration method.
...
* v0.7.1 on 30th May 2015. Remove extra spaces between all tags.
* v0.7.5 on 22th June 2018. Improvement; keep google bot comments.
* v1.0 on 14th July 2018. better support for IE conditional comments into the @head@ part of the document; support for the Google comments (i.e. @<!--googleoff: all-->@); better support for accentuated languages.
* v1.1 on 23th July 2018. Final version.
* v1.1.1 on 25th August 2018. Add option to only compress when the site production status is ‘live’.
* v1.1.2 on 18th November 2019. Correct tag registration.
...
Special thanks to "Ruud":http://vanmelick.com/txp/ for his good advice.
